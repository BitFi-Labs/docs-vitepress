...
Boost Rewards is the recurring insurance-premium distribution that Pulsar bfUSD users receive from Horizon's Insurance Premium. It's meant to reward Pulsar holders for staying in the pool; the longer and more consistently you hold, the more weight and reward you earn each period. For the full mechanics, see the [Boost Rewards Program](/developer/bfusd-overview/boost-rewards) page in the bfUSD developer overview.

...
2. **Verify Eligibility**  
   Complete identity and eligibility checks through Sonar's KYC process. Participation remains subject to jurisdictional requirements and applicable restrictions.

3. **Connect Wallet**  
   Link a Web3 wallet when the sale opens. This wallet is used to submit the commitment and receive any allocation.

4. **Contribute**  
   Submit a contribution during the live sale window using the accepted assets and network specified above.

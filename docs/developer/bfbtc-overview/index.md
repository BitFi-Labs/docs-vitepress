...
bfBTC is BitFi's cross-chain Bitcoin liquidity staking solution, allowing users to securely stake Bitcoin assets (including BTC, BTCB, and hemiBTC) across multiple blockchain networks and mint bfBTC at real-time exchange rates. Users can redeem their staked assets with accrued yields by burning bfBTC.
...
* **Multichain Interoperability**: Use bfBTC on Ethereum, BSC, Bitlayer, Hemi, Base, Core, and Goat;
